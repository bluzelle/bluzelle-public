...
func (app *App) setupUpgradeHandlers(
	...
	app.UpgradeKeeper.SetUpgradeHandler(donothing.UpgradeName, donothing.CreateDoNothingUpgradeHandler(app.mm, configurator, baseAppLegacySS, &app.ConsensusParamsKeeper))
}
