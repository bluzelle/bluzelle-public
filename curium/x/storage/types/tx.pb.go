...
func init() { proto.RegisterFile("storage/tx.proto-temp", fileDescriptor_85eee4bbfcbb21e1) }
...
var fileDescriptor_85eee4bbfcbb21e1 = []byte{
	...
	0x50, 0x00, 0x33, 0xd7, 0xc9, 0xe5, 0xc4, 0x23, 0x39, 0xc6, 0x0b, 0x8f, 0xe4, 0x18, 0x1f, 0x3c,
	0x92, 0x63, 0x9c, 0xf0, 0x58, 0x8e, 0xe1, 0xc2, 0x63, 0x39, 0x86, 0x1b, 0x8f, 0xe5, 0x18, 0xa2,
	0xb4, 0xd2, 0x33, 0x4b, 0x32, 0x4a, 0x93, 0xf4, 0x92, 0xf3, 0x73, 0xf5, 0x61, 0x86, 0xe9, 0x43,
	0x0c, 0xd3, 0xaf, 0xd0, 0x87, 0x87, 0x40, 0x65, 0x41, 0x6a, 0x71, 0x12, 0x1b, 0x38, 0x14, 0x8c,
	0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x95, 0x58, 0xf1, 0x30, 0x19, 0x01, 0x00, 0x00,
}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "storage/tx.proto-temp",
}
...
func (m *MsgPin) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		if wireType == 4 {
			return fmt.Errorf("proto-temp: MsgPin: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto-temp: MsgPin: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MsgPinResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto-temp: MsgPinResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto-temp: MsgPinResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
