...
func init() {
	proto.RegisterType((*MsgPin)(nil), "storage.MsgPin")
	proto.RegisterType((*MsgPinResponse)(nil), "storage.MsgPinResponse")
}
...
var fileDescriptor_85eee4bbfcbb21e1 = []byte{
	...
	,
}
...
func (c *msgClient) Pin(ctx context.Context, in *MsgPin, opts ...grpc.CallOption) (*MsgPinResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/storage.Msg/Pin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (m *MsgPin) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Addrs) > 0 {
		for iNdEx := len(m.Addrs) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintTx(dAtA, i, uint64(len(m.Addrs[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
