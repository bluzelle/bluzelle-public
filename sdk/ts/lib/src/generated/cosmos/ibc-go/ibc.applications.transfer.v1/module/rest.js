...
class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryDenomTraces = (query, params = {}) => this.request(Object.assign({ path: `/ibc/apps/transfer/v1/denom_traces`, method: "GET", query: query, format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryDenomTrace = (hash, params = {}) => this.request(Object.assign({ path: `/ibc/apps/transfer/v1/denom_traces/${hash}`, method: "GET", format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryParams = (params = {}) => this.request(Object.assign({ path: `/ibc/apps/transfer/v1/params`, method: "GET", format: "json" }, params));
    }
}
exports.Api = Api;
