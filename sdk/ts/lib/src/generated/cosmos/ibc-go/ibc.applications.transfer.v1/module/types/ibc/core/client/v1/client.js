...
const baseIdentifiedClientState = { client_id: "" };
...
const baseClientConsensusStates = { client_id: "" };
exports.ClientConsensusStates = {
    ...
    fromJSON(object) {
        ...
        if (object.consensus_states !== undefined &&
            ...
            for (const e of object.consensus_states) {
                message.consensus_states.push(exports.ConsensusStateWithHeight.fromJSON(e));
            }
        }
        return message;
    },
    ...
    fromPartial(object) {
        ...
        if (object.consensus_states !== undefined &&
            object.consensus_states !== null) {
            for (const e of object.consensus_states) {
                message.consensus_states.push(exports.ConsensusStateWithHeight.fromPartial(e));
            }
        }
        return message;
    },
...
const baseHeight = { revision_number: 0, revision_height: 0 };
exports.Height = {
    encode(message, writer = minimal_1.Writer.create()) {
...
const baseParams = { allowed_clients: "" };
exports.Params = {
    encode(message, writer = minimal_1.Writer.create()) {
