...
exports.ProofSpec = {
    ...
    fromJSON(object) {
        ...
        if (object.inner_spec !== undefined && object.inner_spec !== null) {
            message.inner_spec = exports.InnerSpec.fromJSON(object.inner_spec);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.inner_spec !== undefined && object.inner_spec !== null) {
            message.inner_spec = exports.InnerSpec.fromPartial(object.inner_spec);
        }
        else {
            message.inner_spec = undefined;
        }
...
exports.CompressedBatchProof = {
    ...
    fromJSON(object) {
        ...
        if (object.lookup_inners !== undefined && object.lookup_inners !== null) {
            for (const e of object.lookup_inners) {
                message.lookup_inners.push(exports.InnerOp.fromJSON(e));
            }
        }
        return message;
    },
    ...
    fromPartial(object) {
        ...
        if (object.lookup_inners !== undefined && object.lookup_inners !== null) {
            for (const e of object.lookup_inners) {
                message.lookup_inners.push(exports.InnerOp.fromPartial(e));
            }
        }
        return message;
    },
