...
export declare const IdentifiedChannel: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): IdentifiedChannel;
...
export declare const Packet: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): Packet;
...
export declare const PacketState: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): PacketState;
...
export declare const Acknowledgement: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): Acknowledgement;
