...
exports.default = {
    ...
    getters: {
        ...
        getSigningInfo: (state) => (params = { params: {} }) => {
            ...
            return (_a = state.SigningInfo[JSON.stringify(params)]) !== null && _a !== void 0 ? _a : {};
        },
        getSigningInfos: (state) => (params = { params: {} }) => {
            ...
            return (_a = state.SigningInfos[JSON.stringify(params)]) !== null && _a !== void 0 ? _a : {};
        },
    ...
    actions: {
        ...
        QuerySigningInfo({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params, query = null }) {
            var _a;
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    const key = params !== null && params !== void 0 ? params : {};
                    const queryClient = yield initQueryClient(rootGetters);
                    let value = (yield queryClient.querySigningInfo(key.cons_address)).data;
                    commit('QUERY', { query: 'SigningInfo', key: { params: Object.assign({}, key), query }, value });
                    if (subscribe)
                        commit('SUBSCRIBE', { action: 'QuerySigningInfo', payload: { options: { all }, params: Object.assign({}, key), query } });
                    return (_a = getters['getSigningInfo']({ params: Object.assign({}, key), query })) !== null && _a !== void 0 ? _a : {};
                }
                catch (e) {
        ...
        QuerySigningInfos({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params, query = null }) {
            var _a;
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    const key = params !== null && params !== void 0 ? params : {};
                    const queryClient = yield initQueryClient(rootGetters);
                    let value = (yield queryClient.querySigningInfos(query)).data;
                    while (all && value.pagination && value.pagination.next_key != null) {
                        let next_values = (yield queryClient.querySigningInfos(Object.assign(Object.assign({}, query), { 'pagination.key': value.pagination.next_key }))).data;
                        value = mergeResults(value, next_values);
                    }
                    commit('QUERY', { query: 'SigningInfos', key: { params: Object.assign({}, key), query }, value });
                    if (subscribe)
                        commit('SUBSCRIBE', { action: 'QuerySigningInfos', payload: { options: { all }, params: Object.assign({}, key), query } });
                    return (_a = getters['getSigningInfos']({ params: Object.assign({}, key), query })) !== null && _a !== void 0 ? _a : {};
                }
                catch (e) {
        ...
        sendMsgUnjail({ rootGetters }, { value, fee = [], memo = '' }) {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    const txClient = yield initTxClient(rootGetters);
                    const msg = yield txClient.msgUnjail(value);
