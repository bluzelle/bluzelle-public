...
class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryParams = (params = {}) => this.request(Object.assign({ path: `/cosmos/slashing/v1beta1/params`, method: "GET", format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.querySigningInfos = (query, params = {}) => this.request(Object.assign({ path: `/cosmos/slashing/v1beta1/signing_infos`, method: "GET", query: query, format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.querySigningInfo = (cons_address, params = {}) => this.request(Object.assign({ path: `/cosmos/slashing/v1beta1/signing_infos/${cons_address}`, method: "GET", format: "json" }, params));
    }
}
exports.Api = Api;
