...
class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryAccounts = (query, params = {}) => this.request(Object.assign({ path: `/cosmos/auth/v1beta1/accounts`, method: "GET", query: query, format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryAccount = (address, params = {}) => this.request(Object.assign({ path: `/cosmos/auth/v1beta1/accounts/${address}`, method: "GET", format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryParams = (params = {}) => this.request(Object.assign({ path: `/cosmos/auth/v1beta1/params`, method: "GET", format: "json" }, params));
    }
}
exports.Api = Api;
