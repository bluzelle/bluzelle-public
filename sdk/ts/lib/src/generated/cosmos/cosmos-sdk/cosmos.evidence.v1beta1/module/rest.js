...
class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryAllEvidence = (query, params = {}) => this.request(Object.assign({ path: `/cosmos/evidence/v1beta1/evidence`, method: "GET", query: query, format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryEvidence = (evidence_hash, params = {}) => this.request(Object.assign({ path: `/cosmos/evidence/v1beta1/evidence/${evidence_hash}`, method: "GET", format: "json" }, params));
    }
}
exports.Api = Api;
