...
class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryAllowance = (granter, grantee, params = {}) => this.request(Object.assign({ path: `/cosmos/feegrant/v1beta1/allowance/${granter}/${grantee}`, method: "GET", format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryAllowances = (grantee, query, params = {}) => this.request(Object.assign({ path: `/cosmos/feegrant/v1beta1/allowances/${grantee}`, method: "GET", query: query, format: "json" }, params));
    }
}
exports.Api = Api;
