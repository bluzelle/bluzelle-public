...
const tx_1 = require("./types/storage/tx");
const types = [
    ["/bluzelle.curium.storage.MsgPin", tx_1.MsgPin],
];
...
const txClient = (wallet, { addr: addr } = { addr: "http://localhost:26657" }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return {
        ...
        msgPin: (data) => ({ typeUrl: "/bluzelle.curium.storage.MsgPin", value: tx_1.MsgPin.fromPartial(data) }),
    };
});
