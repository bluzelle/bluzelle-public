...
declare const _default: {
    ...
    getters: {
        getGetTaxInfo: (state: any) => (params?: {
            params: {};
        }) => any;
    ...
    actions: {
        ...
        QueryGetTaxInfo({ commit, rootGetters, getters }: {
            commit: any;
            rootGetters: any;
            getters: any;
        ...
        sendMsgSetGasTaxBp({ rootGetters }: {
            rootGetters: any;
        }, { value, fee, memo }: {
            value: any;
            fee?: never[] | undefined;
        ...
        sendMsgSetTaxCollector({ rootGetters }: {
            rootGetters: any;
        }, { value, fee, memo }: {
            value: any;
            fee?: never[] | undefined;
        ...
        sendMsgSetTransferTaxBp({ rootGetters }: {
            rootGetters: any;
        }, { value, fee, memo }: {
            value: any;
            fee?: never[] | undefined;
        ...
        MsgSetGasTaxBp({ rootGetters }: {
            rootGetters: any;
        }, { value }: {
            value: any;
        }): Promise<import("@cosmjs/proto-signing").EncodeObject>;
        MsgSetTaxCollector({ rootGetters }: {
            rootGetters: any;
        }, { value }: {
            value: any;
        }): Promise<import("@cosmjs/proto-signing").EncodeObject>;
        MsgSetTransferTaxBp({ rootGetters }: {
            rootGetters: any;
        }, { value }: {
            value: any;
        }): Promise<import("@cosmjs/proto-signing").EncodeObject>;
