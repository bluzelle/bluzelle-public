...
export declare const QueryGetTaxInfoRequest: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): QueryGetTaxInfoRequest;
...
export declare const QueryGetTaxInfoResponse: {
    ...
    decode(input: Reader | Uint8Array, length?: number | undefined): QueryGetTaxInfoResponse;
