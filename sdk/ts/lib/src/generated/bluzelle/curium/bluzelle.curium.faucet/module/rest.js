...
class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryMint = (address, params = {}) => this.request(Object.assign({ path: `/bluzelle/curium/faucet/mint/${address}`, method: "GET", format: "json" }, params));
        /**
         * No description
         *
         * @tags Query
         ...
         */
        this.queryParams = (params = {}) => this.request(Object.assign({ path: `/bluzelle/curium/faucet/params`, method: "GET", format: "json" }, params));
    }
}
exports.Api = Api;
