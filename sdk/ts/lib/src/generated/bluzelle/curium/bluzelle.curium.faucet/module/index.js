...
const tx_1 = require("./types/faucet/tx");
const types = [
    ["/bluzelle.curium.faucet.MsgMint", tx_1.MsgMint],
];
...
const txClient = (wallet, { addr: addr } = { addr: "http://localhost:26657" }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return {
        ...
        msgMint: (data) => ({ typeUrl: "/bluzelle.curium.faucet.MsgMint", value: tx_1.MsgMint.fromPartial(data) }),
    };
});
