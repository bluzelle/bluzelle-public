  ...
  fromJSON(object: any): FileDescriptorProto {
    return {
      ...
      weakDependency: Array.isArray(object?.weakDependency)
        ...
        : [],
      optionDependency: Array.isArray(object?.optionDependency)
        ? object.optionDependency.map((e: any) => String(e))
        : [],
...
export const FeatureSetDefaults_FeatureSetEditionDefault = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<FeatureSetDefaults_FeatureSetEditionDefault>, I>
