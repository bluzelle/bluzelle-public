...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     */
    queryChannel: (channel_id: string, port_id: string, params?: RequestParams) => Promise<HttpResponse<V1QueryChannelResponse, RpcStatus>>;
    /**
   * No description
   *
   * @tags Query
   ...
   */
    queryChannelClientState: (channel_id: string, port_id: string, params?: RequestParams) => Promise<HttpResponse<V1QueryChannelClientStateResponse, RpcStatus>>;
    /**
   * No description
   *
   * @tags Query
   ...
   */
    queryChannelConsensusState: (channel_id: string, port_id: string, revision_number: string, revision_height: string, params?: RequestParams) => Promise<HttpResponse<V1QueryChannelConsensusStateResponse, RpcStatus>>;
    /**
     * No description
     *
     * @tags Query
     ...
     */
    queryNextSequenceReceive: (channel_id: string, port_id: string, params?: RequestParams) => Promise<HttpResponse<V1QueryNextSequenceReceiveResponse, RpcStatus>>;
    /**
   * No description
   *
   * @tags Query
   ...
   */
     ...
     */
    queryPacketAcknowledgement: (channel_id: string, port_id: string, sequence: string, params?: RequestParams) => Promise<HttpResponse<V1QueryPacketAcknowledgementResponse, RpcStatus>>;
    /**
   * No description
   *
   * @tags Query
   ...
   */
    queryUnreceivedAcks: (channel_id: string, port_id: string, packet_ack_sequences: string[], params?: RequestParams) => Promise<HttpResponse<V1QueryUnreceivedAcksResponse, RpcStatus>>;
    /**
   * No description
   *
   * @tags Query
   ...
   */
    queryUnreceivedPackets: (channel_id: string, port_id: string, packet_commitment_sequences: string[], params?: RequestParams) => Promise<HttpResponse<V1QueryUnreceivedPacketsResponse, RpcStatus>>;
    /**
     * No description
     *
     * @tags Query
     ...
     */
    queryPacketCommitment: (channel_id: string, port_id: string, sequence: string, params?: RequestParams) => Promise<HttpResponse<V1QueryPacketCommitmentResponse, RpcStatus>>;
    /**
   * No description
   *
   * @tags Query
   ...
   */
    queryPacketReceipt: (channel_id: string, port_id: string, sequence: string, params?: RequestParams) => Promise<HttpResponse<V1QueryPacketReceiptResponse, RpcStatus>>;
    /**
   * No description
   *
   * @tags Query
