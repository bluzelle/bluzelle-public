...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   */
    queryClientConnections: (client_id: string, params?: RequestParams) => Promise<HttpResponse<V1QueryClientConnectionsResponse, RpcStatus>>;
    /**
     * No description
     *
     * @tags Query
     ...
     */
    queryConnection: (connection_id: string, params?: RequestParams) => Promise<HttpResponse<V1QueryConnectionResponse, RpcStatus>>;
    /**
   * No description
   *
   * @tags Query
   ...
   */
    queryConnectionClientState: (connection_id: string, params?: RequestParams) => Promise<HttpResponse<V1QueryConnectionClientStateResponse, RpcStatus>>;
    /**
   * No description
   *
   * @tags Query
   ...
   */
    queryConnectionConsensusState: (connection_id: string, revision_number: string, revision_height: string, params?: RequestParams) => Promise<HttpResponse<V1QueryConnectionConsensusStateResponse, RpcStatus>>;
}
export {};
