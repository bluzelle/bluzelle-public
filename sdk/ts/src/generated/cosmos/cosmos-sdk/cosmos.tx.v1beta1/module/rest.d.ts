...
immediately.
*/
export declare enum V1Beta1BroadcastMode {
...
*/
export declare enum V1Beta1OrderBy {
...
Amino JSON and will be removed in the future
*/
export declare enum V1Beta1SignMode {
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     */
    serviceSimulate: (body: V1Beta1SimulateRequest, params?: RequestParams) => Promise<HttpResponse<V1Beta1SimulateResponse, RpcStatus>>;
    /**
     * No description
     *
     * @tags Service
     ...
     */
    serviceBroadcastTx: (body: V1Beta1BroadcastTxRequest, params?: RequestParams) => Promise<HttpResponse<V1Beta1BroadcastTxResponse, RpcStatus>>;
    /**
     * No description
     *
     * @tags Service
     ...
     */
    serviceGetTx: (hash: string, params?: RequestParams) => Promise<HttpResponse<V1Beta1GetTxResponse, RpcStatus>>;
}
export {};
